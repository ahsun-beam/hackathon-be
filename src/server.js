...
const API_ENDPOINT_BEAM = "https://api.beamstudio.ai/agent-tasks/30be3bae-61b4-44e5-9f18-85ac61eb7ba0/webhook/cf40a37e-5b73-4d21-bbad-86618bb29834?userAccessToken=b10a9442-2266-4dce-8baf-a7d37aae3a54";
...
app.post('/forward', async (req, res) => {
  ...
  try {
    const upstreamResponse = await axios.post(API_ENDPOINT_BEAM, payload, {
      headers: {
